...
$response = $merideApi->create('embed', array(
    'title'=>"Test embed sdk",
    'video_id'=> '3',
    'scrollmode_enabled'=> 1,
    'scrollmode_destroy_on'=>array(
        "AD_ERROR",
        "ENDED"
    ),
));

echo var_dump($response->hasErrors());
echo var_dump($response->getApiResponse());
echo var_dump($response->isEmpty());
die();
